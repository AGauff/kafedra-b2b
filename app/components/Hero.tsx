export default function Hero() {
  return (
    <section className="relative w-full h-screen max-h-[900px] flex flex-col bg-black">
      {/* Background image */}
      ...
      {/* Logo */}
      <div className="relative z-10 px-8 md:px-16 pt-6">
        <img
      ...
      {/* Content */}
      <div className="relative z-10 px-8 md:px-16 pb-12 mt-auto">
        ...
        <p className="text-xs md:text-sm text-white/60 max-w-xl mb-6 leading-relaxed">
