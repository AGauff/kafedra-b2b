export default function Hero() {
  return (
    <section className="relative w-full h-screen max-h-[900px] flex flex-col bg-black overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full z-[2] px-8 md:px-16 pt-8 opacity-[0.08]">
        <img
          src="https://static.tildacdn.com/tild3761-3231-4963-b235-323335623836/Group_1480.svg"
          className="w-full"
        />
      </div>
      <div className="relative z-[3] px-8 md:px-16 pt-8 mb-auto">
        <span className="text-xs font-bold text-white/60 uppercase tracking-widest">Kafedra by dreamlaser</span>
      </div>
      <div className="relative z-[3] px-8 md:px-16 pb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-6 border-t border-white/10">
          <div>
            ...
            <p className="text-[10px] text-white/40 uppercase tracking-widest mt-1">лет в индустрии</p>
          </div>
          <div>
            <p className="text-2xl md:text-3xl font-bold text-white">5 000+</p>
            <p className="text-[10px] text-white/40 uppercase tracking-widest mt-1">реализованных проектов</p>
          </div>
          <div>
            <p className="text-2xl md:text-3xl font-bold text-white">3</p>
            <p className="text-[10px] text-white/40 uppercase tracking-widest mt-1">потока Multimedia Foundation</p>
          </div>
          <div>
            <p className="text-2xl md:text-3xl font-bold text-white">83%</p>
            <p className="text-[10px] text-white/40 uppercase tracking-widest mt-1">выбирают офлайн-практику</p>
          </div>
        </div>
      </div>
    </section>
