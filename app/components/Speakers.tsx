        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          ...
          <div className="flex items-end">
            <p className="text-sm text-black leading-relaxed">
              Они создают мультимедиа-проекты, которыми живёт индустрия: световые шоу, сцены для крупных мероприятий, архитектурные видеомэппинги, арт-инсталляции, иммерсивные проекты. Их профессионализм формирует содержание наших программ: мы учим тому, что действительно работает в продакшне и на площадке.
            </p>
          </div>
        </div>
